...
import { IArdentisVault, IArdentis, MarketAllocation, Id, MarketParams } from "ardentis-vault/interfaces/IArdentisVault.sol";
...
interface IVaultAllocatorBase {
  ...
  /// @param vault The ArdentisVault vault to reallocate.
  ...
  /// @dev Will call ArdentisVault's `reallocate`.
