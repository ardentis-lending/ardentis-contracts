...
import { IOracle, TokenConfig } from "../ardentis/interfaces/IOracle.sol";
...
contract PTLinearDiscountMarketOracle is UUPSUpgradeable, AccessControlEnumerableUpgradeable, IOracle {
  ...
  /// @param _baseTokenOracle The address of the base token oracle, for example: Ardentis ResilientOracle
  /// @param _loanAsset The address of the loan asset
  /// @param _loanTokenOracle The address of the loan token oracle, for example: Ardentis ResilientOracle or OracleAdapter
  function initialize(
    address admin,
    address _asset,
