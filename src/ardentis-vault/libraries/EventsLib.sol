...
library EventsLib {
  ...
  /// @notice Emitted when a new ArdentisVault vault is created.
  /// @param ardentisVault The address of the ArdentisVault.
  /// @param implementation The implementation of the ArdentisVault.
  /// @param managerTimeLock The manager timeLock contract of the ArdentisVault.
  /// @param curatorTimeLock The curator timeLock contract of the ArdentisVault.
  /// @param timeLockDelay The delay of the timeLock.
  /// @param caller The caller of the function.
  /// @param manager The initial manager of the ArdentisVault vault.
  /// @param curator The initial curator of the ArdentisVault vault.
  /// @param guardian The initial guardian of the ArdentisVault vault.
  /// @param asset The address of the underlying asset.
  /// @param name The name of the ArdentisVault vault.
  /// @param symbol The symbol of the ArdentisVault vault.
  event CreateArdentisVault(
    address indexed ardentisVault,
