...
contract ArdentisVaultDeploy is Script {
  ...
  string name = "Ardentis USD1 Vault";
  string symbol = "ArdentisUSD1";
  ...
  function run() public {
    ...
    ArdentisVault impl = new ArdentisVault(ardentis, asset);
    console.log("ArdentisVault implementation: ", address(impl));
    ...
    ArdentisVault vault = ArdentisVault(address(proxy));
    // setup roles
