...
contract ArdentisVaultConfigDeploy is Script {
  ...
  // todo update vault
  ArdentisVault WBNBVault = ArdentisVault(0x6d6783C146F2B0B2774C1725297f1845dc502525);
  ArdentisVault USD1Vault = ArdentisVault(0x6d6783C146F2B0B2774C1725297f1845dc502525);
  ...
  function configWBNB(address deployer, ArdentisVault vault) internal {
  ...
  function configUSD1(address deployer, ArdentisVault vault) internal {
    MarketParams memory solvBTCParams = MarketParams({
      loanToken: USD1,
      collateralToken: solvBTC,
      oracle: multiOracle,
