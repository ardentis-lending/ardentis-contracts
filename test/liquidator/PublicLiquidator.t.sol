...
import "../ardentis/BaseTest.sol";

import { PublicLiquidator, IPublicLiquidator } from "liquidator/PublicLiquidator.sol";
import { MarketParamsLib, MarketParams, Id } from "ardentis/libraries/MarketParamsLib.sol";
...
contract PublicLiquidatorTest is BaseTest {
  ...
  function setUp() public override {
    ...
    PublicLiquidator impl = new PublicLiquidator(address(ardentis));
  ...
  function testLiquidate() public {
    ...
    ardentis.borrow(marketParams, 8e18, 0, address(this), address(this));
  ...
  function testNonWhitelistLiquidate() public {
    ...
    vm.prank(OWNER);
    ardentis.addLiquidationWhitelist(marketParams.id(), makeAddr("WHITELISTOR"));
  ...
  function testNonWhitelistLiquidate_batch() public {
    ...
    // make this market only whitelisted address can liquidate
    vm.prank(OWNER);
    ardentis.batchToggleLiquidationWhitelist(ids, accounts, true);
